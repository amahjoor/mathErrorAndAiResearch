...
model = tf.keras.models.load_model('math_error_detection_model.h5')
...
print(classification_report(y_test, y_pred_classes, target_names=['correct', 'addition_error', 'subtraction_error']))
